...
const PIZZA_SIZES = [
  { id: "small", name: "Pequena",description: "4 fatias", extraPrice: 25,90 },
  { id: "medium", name: "Média", description: "6 fatias", extraPrice: 30,90 },
  { id: "large", name: "Grande", description: "8 fatias", extraPrice: 35,90 },
] as const
